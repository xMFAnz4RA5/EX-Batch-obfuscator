...
def main():
    print("Fast -Batch -Verschleierungsinstrument")
    filepath = input("Bitte stellen Sie die Batch -Datei ab: ").strip().strip('"')
    ...
    print("Verschleierte Stapeldatei wurde ausgegeben:", output_path)
    try:
        system('pause >nul')
    except:
        pass
